...
//        });
    ...
    BaseAdapter adapter = new BaseAdapter() {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (position == 9) {
                holder.btnNumber.setText("删除");
                holder.btnNumber.setTextSize(17);
                holder.btnNumber.setTextColor(mContext.getResources().getColor(R.color.red));
                holder.btnNumber.setBackgroundColor(mContext.getResources().getColor(R.color.graye3));
            }
            if (position == 11) {
                holder.btnNumber.setText("确定");
                holder.btnNumber.setTextSize(17);
                holder.btnNumber.setTextColor(mContext.getResources().getColor(R.color.blue));
