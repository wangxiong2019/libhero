 ...
 *    desc   : 正则输入限制编辑框
 */
public class EditTextRegex extends AppCompatEditText implements InputFilter {
    ...
    public EditTextRegex(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public EditTextRegex(Context context, AttributeSet attrs, int defStyleAttr) {
