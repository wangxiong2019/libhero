 ...
 *
 * 作者：Blankj
 * 链接：https://www.jianshu.com/p/960467ac56c8
 * 来源：简书
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(LibHeroInitializer.appContext, bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(LibHeroInitializer.appContext, uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(LibHeroInitializer.appContext, resourceId), start, end, flag);
                    resourceId = 0;
